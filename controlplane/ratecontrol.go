...
const (
	...
	PACKET_WAITING_TIME           = 400000 // 200000
	CONGESTION_WINDOW_MAX         = 100000
...
func (rc *RateControl) Add(numPackets int, numBytes int64) {
	...
	if rc.lastIntervalPackets%int64(rc.congestionWindow) == 0 && rc.windowCompletionTime != 0 && rc.congestionWindow < CONGESTION_WINDOW_MAX { // TODO: Check this constant
